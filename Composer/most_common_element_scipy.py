# scipy package is used as it not available by-default in Cloud Composer.
# gcloud composer environments update <environment-name> --update-pypi-packages-from-file requirements.txt --location <location> --async
